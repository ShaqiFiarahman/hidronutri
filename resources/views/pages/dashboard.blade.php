...
@section('content')
  <div class="page-wrapper">
    ...
    <section class="hero-section relative h-[85vh] min-h-[600px] overflow-hidden">
      ...
      <img src="https://images.unsplash.com/photo-1530836369250-ef72a3f5cda8?w=1600&q=85&auto=format&fit=crop"
        alt="Kebun hidroponik modern" class="absolute inset-0 w-full h-full object-cover hero-img" loading="lazy">
          ...
          <div class="max-w-xl">
            ...
            <h1 class="text-5xl md:text-6xl font-black text-white 
              ...
              <span class="inline-block overflow-hidden align-bottom"><span
                  class="text-brand-moss inline-block gsap-cerdas"
                  style="transform: translateY(100%);">Cerdas</span></span> <span
                class="inline-block gsap-left">dengan</span><br>
            ...
            <div class="flex gap-4 flex-wrap gsap-stagger">
              <a href="{{ route('rekomendasi') }}" class="bg-white text-brand-black font-semibold 
              ...
              <a href="#panduan" class="bg-white/10 backdrop-blur-sm text-white 
    ...
    <section class="bg-brand-black py-16">
      <div class="max-w-7xl mx-auto px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div class="text-center">
            <div class="text-5xl font-black text-white stat-number" data-target="48" data-suffix="">0</div>
            <div class="text-sm text-white/60 leading-relaxed mt-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="bg-brand-offwhite rounded-3xl overflow-hidden gsap-scale">
            <div class="relative h-48">
              <img src="{{ asset('images/ph_measurement.png') }}" alt="pH meter hidroponik"
          ...
          <div class="bg-brand-offwhite rounded-3xl overflow-hidden gsap-scale">
            <div class="relative h-48">
              <img src="https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=600&q=80&auto=format&fit=crop"
                alt="EC meter hidroponik" class="w-full h-full object-cover" loading="lazy">
              <div class="absolute inset-0 bg-gradient-to-t 
                            from-black/50 to-transparent"></div>
              <span class="absolute bottom-4 left-4 text-white 
          ...
          <div class="bg-brand-offwhite rounded-3xl overflow-hidden gsap-scale">
            <div class="relative h-48">
              <img src="https://images.unsplash.com/photo-1622206151226-18ca2c9ab4a1?w=600&q=80&auto=format&fit=crop"
                alt="TDS meter PPM hidroponik" class="w-full h-full object-cover" loading="lazy">
              <div class="absolute inset-0 bg-gradient-to-t 
                            from-black/50 to-transparent"></div>
              <span class="absolute bottom-4 left-4 text-white 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 gsap-stagger">
          ...
          @php
            $sistem = [
              [
                'nama' => 'NFT',
                'full' => 'Nutrient Film Technique',
                'desc' => 'Larutan mengalir tipis di dasar pipa. Hemat air, cocok untuk sayuran daun seperti selada dan pakcoy.',
                'level' => 'Menengah',
                'foto' => 'https://images.unsplash.com/photo-1530836369250-ef72a3f5cda8?w=400&q=80&auto=format&fit=crop'
              ],
              [
                'nama' => 'DFT',
                'full' => 'Deep Flow Technique',
                'desc' => 'Akar terendam larutan lebih dalam. Lebih stabil dan toleran jika pompa mati beberapa jam.',
                'level' => 'Menengah',
                'foto' => 'https://images.unsplash.com/photo-1598123586091-ff6a30ed031c?w=400&q=80&auto=format&fit=crop'
              ],
              [
                'nama' => 'Rakit Apung',
                'full' => 'Floating Raft System',
                'desc' => 'Tanaman di atas styrofoam yang mengapung di bak larutan. Paling mudah dan murah untuk pemula.',
                'level' => 'Pemula',
                'foto' => 'images/rakit_apung.png'
              ],
              [
                'nama' => 'Wick',
                'full' => 'Wick System',
                ...
                'level' => 'Pemula',
                'foto' => 'https://images.unsplash.com/photo-1592841200221-a6898f307baa?w=400&q=80&auto=format&fit=crop'
              ],
            ];
          @endphp
          ...
          @foreach($sistem as $s)
                <div class="bg-white rounded-2xl overflow-hidden border 
                  ...
                  <div class="relative h-44">
                    <img src="{{ str_starts_with($s['foto'], 'http') ? $s['foto'] : asset($s['foto']) }}" alt="{{ $s['nama'] }}"
    ...
    <section class="py-20 bg-white">
      <div class="max-w-7xl mx-auto px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <!-- Artikel utama -->
          <a href="https://hidroponikpedia.com/kepadatan-tanam-salah-produktivitas-hidroponik/" target="_blank"
            class="block bg-brand-offwhite rounded-3xl overflow-hidden hover:shadow-xl hover:shadow-brand-green/5 hover:-translate-y-2 transition-all duration-500 ease-out gsap-left group">
            <div class="relative h-64 overflow-hidden">
              <img src="https://hidroponikpedia.com/wp-content/uploads/2026/02/kepadatan-tanam-hidroponik-yang-salah.jpg"
                alt="Jarak tanam hidroponik"
                class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-108" loading="lazy">
              <div class="absolute inset-0 bg-gradient-to-t 
            ...
            <div class="p-6">
              ...
              <p class="text-sm text-brand-gray leading-relaxed">
                Menanam terlalu rapat dengan harapan panen berlimpah justru sering menjadi bumerang. Jarak tanam yang
                ideal menjamin sirkulasi udara dan distribusi nutrisi cahaya yang maksimal bagi setiap tanaman.
              </p>
          ...
          <div class="flex flex-col gap-6 gsap-right">
            ...
            <a href="https://farmee.id/tips-trik-penggunaan-nutrisi-ab-mix/" target="_blank"
              class="bg-brand-offwhite rounded-3xl overflow-hidden 
              ...
              <div class="relative w-36 flex-shrink-0 overflow-hidden">
                <img src="https://farmee.id/wp-content/uploads/2020/09/IMG_20200923_194353-1600x900.jpg"
              ...
              <div class="p-5">
                ...
                <p class="text-xs text-brand-gray leading-relaxed">
                  Bagi kalangan hidroponik pasti tidak asing dengan nutrisi AB mix. Pelajari cara manajemen mulai dari
                  dosis penggunaan hingga penyimpanannya agar awet.
                </p>
              </div>
            </a>

            <a href="https://npkmutiara.com/post/pentingnya-ph-dalam-budidaya-sistem-hidroponik" target="_blank"
              class="bg-brand-offwhite rounded-3xl overflow-hidden 
                          flex hover:shadow-xl hover:shadow-brand-green/5 hover:-translate-y-2 transition-all duration-500 ease-out group">
              <div class="relative w-36 flex-shrink-0 overflow-hidden">
                <img src="https://npkmutiara-prod.s3.ap-southeast-1.amazonaws.com/2025/09/13-large.jpg"
              ...
              <div class="p-5">
                ...
                <p class="text-xs text-brand-gray leading-relaxed">
                  Pengaturan pH larutan nutrisi sangat menentukan keberhasilan tanaman dalam menyerap nutrisi dengan
                  maksimal. Pahami kisaran idealnya.
                </p>
              </div>
            </a>
    ...
    <section class="py-24 relative overflow-hidden cta-section" style="background: linear-gradient(135deg, 
                      #1a4a06 0%, 
                      #2D6A0F 40%, 
                      #4A9020 70%, 
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-8 text-center">
        ...
        <a href="{{ route('rekomendasi') }}" class="inline-flex items-center gap-2 
    ...
    <div class="relative z-10 -mb-1" style="background: linear-gradient(135deg, 
                  #1a4a06 0%, #2D6A0F 40%, 
                  #4A9020 70%, #3B6D11 100%);">
      <svg viewBox="0 0 1440 60" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none"
        class="w-full h-12 md:h-16">
        <path d="M0,0 C360,60 1080,60 1440,0 L1440,60 L0,60 Z" fill="#0D0D0D" />
      </svg>
    </div>
  </div>
@endsection